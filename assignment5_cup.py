...
def assignment_5_cup_visible_cutting():
    ...
    if not os.path.exists("cup.obj"):
        print("ERROR: cup.obj file not found!")
        return
    ...
    cutting_line.paint_uniform_color([1.0, 0.0, 0.0])
    ...
    o3d.visualization.draw_geometries([cup_for_display, plane, cutting_plane, cutting_line], 
                                    window_name="Step 5: Cup with Cutting Plane",
    ...
    # FIXED: Clip the point cloud, not the mesh vertices
    points = np.asarray(point_cloud.points)
    clipping_threshold = cutting_x + cutting_plane_width/2
